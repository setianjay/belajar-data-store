...
class SettingsPreferences private constructor(private val dataStore: DataStore<Preferences>) {
    ...
    companion object {
        ...
        /* function to get instance from this class, because this class is singleton */
    ...
    /* function to get theme data from datastore */
    ...
    /* function to set theme data to datastore*/
